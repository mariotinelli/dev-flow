...
{
    /**
     * @return array{id: int, title: string, description: string|null, type: int, type_label: string, category: int, category_label: string, visibility: int, visibility_label: string, url: string|null, download_url: string|null, author: array{id: int, name: string}, created_at: string|null, can: array{update: bool, delete: bool}}
     */
