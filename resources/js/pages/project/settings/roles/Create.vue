...
import StoreController from '@/actions/App/Http/Controllers/Project/Settings/Roles/StoreController';
...
<template>
    <div class="flex h-full flex-1 flex-col gap-6">
        <Head title="Novo papel do projeto" />

        <Heading
            title="Novo papel do projeto"
            description="Crie um papel com permissões aplicáveis dentro de um projeto."
        />
        ...
        >
            <div class="grid gap-2">
                ...
                <Input id="name" name="name" required placeholder="gestor-do-projeto" />
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                            ...
                            <p class="text-sm text-muted-foreground">
                                Selecione as ações permitidas para este papel dentro dos projetos.
                            </p>
                        </div>
