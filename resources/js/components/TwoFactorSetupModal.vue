...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação de dois fatores agora está ativada. Escaneie o QR code ou informe a chave de configuração no seu aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
                ...
                <template v-if="!showVerificationStep">
                    ...
                    <template v-else>
                        ...
                        <div class="relative flex w-full items-center justify-center">
                            ...
                            <span class="relative bg-card px-2 py-1">ou informe o código manualmente</span>
                        </div>
                            ...
                            <div class="flex w-full items-stretch overflow-hidden rounded-xl border border-border">
                                ...
                                <template v-else>
                                    ...
                                    <button
                                        ...
                                        class="relative block h-auto cursor-pointer border-l border-border px-3 hover:bg-muted"
                                    >
